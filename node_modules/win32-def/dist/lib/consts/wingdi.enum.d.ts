 ...
 */
export declare const enum DISPLAYCONFIG_ROTATION {
 ...
 */
export declare const enum DISPLAYCONFIG_SCALING {
 ...
 */
export declare const enum DISPLAYCONFIG_SCANLINE_ORDERING {
...
//# sourceMappingURL=wingdi.enum.d.ts.map